  ...
  <div class="container mt-5">
    ...
    <form action="<?= site_url('assessment_info/add_data') ?>" method="post" autocomplete="off">
        ...
        <tr>
          ...
          <td>
            <div class=" row">
              ...
              <div class="col-8">
                <input class="form-control" type="text" name="NO_REGISTRATION" id="NO_REGISTRATION" placeholder="No.MR" value="<?= $detail['NO_REGISTRATION']; ?>" readonly>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8">
                <input class="form-control" type="text" name="THENAME" id="THENAME" placeholder="Nama Lengkap" value="<?= $detail['THENAME']; ?>" readonly>
              </div>
            </div>
      ...
      <div class="container mt-5">
        ...
        <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;a. <input type="text" name="V_01" id="V_01" value="<?= $detail['V_01'] ?>" readonly></h5>

        <!-- b -->
        <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;b. <input type="text" name="V_02" id="V_02" value="<?= $detail['V_02'] ?>" readonly></h5>

        <!-- c -->
        <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;c. <input type="text" name="V_03" id="V_03" value="<?= $detail['V_03'] ?>" readonly></h5>
      ...
      <table class="table table-bordered mb-5">
        <tr>
          <td class="text-center">
            Bengkulu,<input type="date" name="V_06" id="V_06" value="<?= $detail['V_06'] ?>" readonly>
          </td>
          <td class="text-center">
            Jam: <input type="time" name="V_07" id="V_07" value="<?= $detail['V_07'] ?>" readonly> WIB
          </td>
        </tr>
        <tr>
          <td class="text-center">
