    ...
    <div class="container">
        ...
        <form action="" method="">
            ...
            <table class="table table-bordered" style="border: 1px;">
                <tr>
                    <td width="70%">
                        <h6><strong>FORMULIR ASUHAN GIZI ANAK</strong></h6>
                    </td>
                    <td>
                    ...
                    <td colspan="2">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-3">
                                        <label for="V_04">Umur</label>
                                    </div>
                                    <div class="col-3">
                                        <span>:</span>
                                        <input type="text" id="V_04" name="V_04" style="width: 91%;">
                                    </div>
                                    <div class="col-1 ">
                                        <span>Th</span>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <label for="V_09">LK</label>
                                    </div>
                                    <div class="col-3">
                                        <span>:</span>
                                        <input type="text" id="V_09" name="V_09" style="width: 91%;">
                                    </div>
                                    <div class="col-1">
                                        <span>Cm</span>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <label for="V_10">BB Ideal</label>
                                    </div>
                                    <div class="col-3">
                                        <span>:</span>
                                        <input type="text" id="V_10" name="V_10" style="width: 91%;">
                                    </div>
                                    <div class="col-1">
                                        <span>Kg</span>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <label for="V_13">BB/TB</label>
                                    </div>
                                    <div class="col-3">
                                        <span>:</span>
                                        <input type="text" id="V_13" name="V_13" style="width: 91%;">
                                    </div>
                                    <div class="col-1">
                                        <span>%</span>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <label for="V_14">LLA/U</label>
                                    </div>
                                    <div class="col-3">
                                        <span>:</span>
                                        <input type="text" id="V_14" name="V_14" style="width: 91%;">
                                    </div>
                                    <div class="col-1">
                                        <span>%</span>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <label for="V_15">Kesimpulan</label>
                                    </div>
                                    <div class="col-3">
                                        <span>:</span>
                                        <input type="text" id="V_15" name="V_15" style="width: 91%;">
                                    </div>
                                    <div class="col-1">
                                        <span>%</span>
                                    </div>
                ...
                <tr>
                    <td colspan="2">
                        <textarea name="V_19" id="V_19" cols="30" rows="10" style="width: 100%;"></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">
                        <textarea name="V_20" id="V_20" cols="30" rows="10" style="width: 100%;"></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <span>Kebutuhan kalori sehari (Penuntun Diet Anak)</span>
                                <div class="container">
                                    <table class="table table-bordered" style="border: 1px;">
                                        <tr>
                                            <td class="text-center">
                                                <span><strong>Gol umur <br>(tahun)</strong></span>
                                            </td>
                                            <td class="text-center">
                                                <span><strong>Pria (Kcal/kg <br>BB)</strong></span>
                                            </td>
                                            <td class="text-center">
                                                <span><strong>Wanita (Kcal/kg <br>BB)</strong></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">
