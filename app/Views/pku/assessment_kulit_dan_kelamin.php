...
<head>
    ...
    <title>Assessment Kulit dan Kelamin</title>
                ...
                <tr>
                    <td>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <p><strong>C. Status Lokalis (<i>Dermatovenerologik</i>)</strong></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <strong><u>Status Dermatologik</u></strong>
                                    <ol type="i">
                                        <li>
                                            <span>Inspeksi</span>
                                            <ol type="a">
                                    ...
                                    <strong><u>Status Venerologik</u></strong>
                                    <ol type="i">
                                        <li>
                                            Inspeksi :
                                ...
                                <div class="col-md-6">
                                    <img src="<?= base_url('uploads/kulit_kelamin.png') ?>" alt="" style="width: 70%; margin-left: 100px; ">
                                </div>
                            </div>
                            <div class="mt-3">
                            ...
                            <div class="row">
                                <div class="col-6 text-center">
                                    <span>(<input type="text" id="V_74" name="V_74" placeholder="Masukan Nama" style="text-align: center;">)</span>
                                </div>
                                <div class="col-6 text-center">
                                    <span>(<input type="text" id="V_75" name="V_75" placeholder="Masukan Nama" style="text-align: center;">)</span>
                                </div>
                            </div>
                    </td>
                </tr>
