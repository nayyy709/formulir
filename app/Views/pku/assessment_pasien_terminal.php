                ...
                <tr>
                    <td>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="row">
                                <div class="col-6 text-center">
                                    <span>(<input type="text" id="V_17" name="V_17" placeholder="Masukan Nama" style="text-align: center;">)</span>
                                </div>
                                <div class="col-6 text-center">
                                    <span>(<input type="text" id="V_18" name="V_18" placeholder="Masukan Nama" style="text-align: center;">)</span>
                                </div>
                            </div>
                    </td>
                </tr>
