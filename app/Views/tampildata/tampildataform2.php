            ...
            <tbody>
                <?php foreach ($all_data as $pasien) : ?>
                    <tr align="center">
                        ...
                        <td>
                            <a href="<?= base_url('pasien/form2/') . $pasien['NOID'] ?>" class="btn btn-warning" data-bs-toggle="tooltip" data-placement="top" title="Insert"><i class="bi bi-file-earmark-plus-fill"></i></a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
